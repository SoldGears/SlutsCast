...
import cast.slutscast.adapters.LoaderAdapter
import cast.slutscast.adapters.addons.EndlessRecyclerOnScrollListener
import cast.slutscast.models.Model
import cast.slutscast.viewmodels.ViewModel
...
class LoaderFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (arguments != null) {
            if (requireArguments().containsKey("Key")) urlString = requireArguments().getString("Key").toString()
        }
        adapter = LoaderAdapter(requireContext())
    }
