package cast.slutscast.adapters
...
import cast.slutscast.adapters.LoaderAdapter.ViewHolder
...
import cast.slutscast.activitys.DetailActivity
            ...
            if (this.modelLink.text.contains("chaturbate")){
                ...
                scope.launch {
                    ...
                    withContext(Dispatchers.Main) {
                        ...
                        Toast.makeText(itemView.context, modelName.text, Toast.LENGTH_SHORT).show()
