package cast.slutscast.adapters.addons
...
import cast.slutscast.fragments.QUERY_PER_PAGE

abstract class EndlessRecyclerOnScrollListener(private val threshHold: Int = QUERY_PER_PAGE) : RecyclerView.OnScrollListener() {
